...
public final class PortServiceOrderDaoJpa
        extends CommonDaoJpa<PortServiceOrder> implements PortServiceOrderDao {
    /**
     ...
     */
    @NotNull
    public PortServiceOrderDaoJpa(final EntityManager em) {
