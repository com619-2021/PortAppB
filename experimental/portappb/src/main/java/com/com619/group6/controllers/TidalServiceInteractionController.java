...
public class TidalServiceInteractionController {
	...
	/**
	 * Get the height of the tide at the port.
	 * Optionally accepts time. If time not supplied then will check tide height at time of request.
	...
	/**
	 * Is the height of the tide acceptable?
	 * Optionally accepts time. If time not supplied then will check tide height at time of request.
	 * @TODO: Accept ship info? Different ships have different displacements so some ships might be ok in high tide.
	 * @param time Time to check tide height (optional)
